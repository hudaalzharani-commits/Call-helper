...
export const callHelperEn = {
  callHelper: {
    ...
    feedback: {
      ...
      yes: 'Yes',
      no: 'No',
      teachRafeeq: 'Teach Rafeeq',
      teachTooltipFull:
        'Opens "Teach Rafeeq from your experience" with fields prefilled from this call',
      teachTooltipAuto:
        'Opens "Teach Rafeeq from your experience" with auto-filled fields',
    },
    advancedMode: {
      title: 'Advanced mode',
    ...
    rafeeq: {
      chatTitle: 'Chat with Rafeeq',
      chatDescription: 'Your AI assistant for your questions',
      welcome: 'Welcome!',
      welcomeHint: 'Tap to start chatting with Rafeeq',
      start: 'Start Rafeeq',
      placeholder: 'Type your message...',
      greeting: 'Hello! I am Rafeeq, your AI assistant. How can I help?',
    },
    templates: {
      primary:
