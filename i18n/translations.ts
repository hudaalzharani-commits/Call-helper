...
const shellEn = {
  ...
  services: {
    ...
    'what-did-rafeeq-learn': 'What did Rafeeq learn?',
  },
  askRafeeq: {
    title: 'Ask Rafeeq',
  ...
  login: {
    ...
    footer: 'Rafeeq · Call Assistant · v1.0',
  },
  knowledge: {
    ...
    sources: {
      ...
      rafeeq_training: 'From Rafeeq training',
...
export const translations = {
  ar: mergeLocales(commonAr, callHelperAr, dashboardAr, adminAr, shellAr),
  en: mergeLocales(commonEn, callHelperEn, dashboardEn, adminEn, shellEn),
} as const;
